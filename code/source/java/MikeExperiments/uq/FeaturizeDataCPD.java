...
public class FeaturizeDataCPD extends TaskDef {
	...
	private void featurizeData(String expRootPath, String datasetStr,
		...
		featurizeGroundTruth(expPath, clusterJobNum, useCluster, featurizeFunctionScriptPath, callingScriptPath, clusterWorkspace, eventsFileNames, truncatedFileNames, duplicatesFileNames, frequency, featurizeDataPath);
