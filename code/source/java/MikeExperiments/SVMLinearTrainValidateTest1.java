...
public class SVMLinearTrainValidateTest1 extends TaskDef {
	...
	private void trainValidate(Var expPath, Var modelId, 
			String clusterWorkspace, String jobId, Array formula,
	...
	private void testBestModel(Array formulaName, Var expPath, 
	...
	private void summarizeTest(String clusterWorkspace, String jobId,
			Var expPath, Var bestModelId, Var testResultPath, 
			Var confusionMatrixPath, Var pctConsufionMatrixPath, 
			Var summaryPath) throws Exception {
