...
\begin{figure}[H]
 \includegraphics[scale=0.38]{osu_cpd_dt_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_cpd_dt_det.pdf}
 \includegraphics[scale=0.38]{osu_cpd_svm_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_cpd_svm_det.pdf}
 \includegraphics[scale=0.38]{osu_cpd_nnet_acc.pdf} \hspace{2em}
 \includegraphics[scale=0.38]{osu_cpd_nnet_det.pdf}
...
\begin{figure}[H]
 \centering
 \includegraphics[scale=0.38]{lime1_cpd_dt_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_cpd_dt_det.pdf}
 \includegraphics[scale=0.38]{lime1_cpd_svm_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_cpd_svm_det.pdf}
 \includegraphics[scale=0.38]{lime1_cpd_nnet_acc.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime1_cpd_nnet_det.pdf}
...
\begin{figure}[H]
 \centering
 \includegraphics[scale=0.38]{lime2_cpd_dt_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_cpd_dt_det.pdf}
 \includegraphics[scale=0.38]{lime2_cpd_svm_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_cpd_svm_det.pdf}
 \includegraphics[scale=0.38]{lime2_cpd_nnet_acc.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime2_cpd_nnet_det.pdf}
...
\begin{figure}[H]
 ...
 \includegraphics[scale=0.38]{osu_dt_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_dt_hmm_nohmm_compare_det.pdf} 
 \includegraphics[scale=0.38]{osu_svm_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_svm_hmm_nohmm_compare_det.pdf}
 \includegraphics[scale=0.38]{osu_nnet_hmm_nohmm_compare_acc.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{osu_nnet_hmm_nohmm_compare_det.pdf}
...
\begin{figure}[H]
 \centering
 %\includegraphics[scale=0.3]{vspace.png}
 \includegraphics[scale=0.38]{lime1_dt_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_dt_hmm_nohmm_compare_det.pdf} 
 \includegraphics[scale=0.38]{lime1_svm_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_svm_hmm_nohmm_compare_det.pdf}
 \includegraphics[scale=0.38]{lime1_nnet_hmm_nohmm_compare_acc.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime1_nnet_hmm_nohmm_compare_det.pdf}
...
\begin{figure}[H]
 \centering
 %\includegraphics[scale=0.3]{vspace.png}
 \includegraphics[scale=0.38]{lime2_dt_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_dt_hmm_nohmm_compare_det.pdf} 
 \includegraphics[scale=0.38]{lime2_svm_hmm_nohmm_compare_acc.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_svm_hmm_nohmm_compare_det.pdf}
 \includegraphics[scale=0.38]{lime2_nnet_hmm_nohmm_compare_acc.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime2_nnet_hmm_nohmm_compare_det.pdf}
...
%\begin{figure}[H]
% \centering
% \includegraphics[scale=0.38]{osu_hmm_dt_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{osu_hmm_dt_det.pdf}
% \includegraphics[scale=0.38]{osu_hmm_svm_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{osu_hmm_svm_det.pdf}
% \includegraphics[scale=0.38]{osu_hmm_nnet_acc.pdf} \hspace{1em}
% \includegraphics[scale=0.38]{osu_hmm_nnet_det.pdf}
...
%\begin{figure}[H]
% \centering
% \includegraphics[scale=0.38]{lime1_hmm_dt_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{lime1_hmm_dt_det.pdf} 
% \includegraphics[scale=0.38]{lime1_hmm_svm_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{lime1_hmm_svm_det.pdf} 
% \includegraphics[scale=0.38]{lime1_hmm_nnet_acc.pdf} \hspace{1em}
% \includegraphics[scale=0.38]{lime1_hmm_nnet_det.pdf} 
...
%\begin{figure}[H]
% \centering
% \includegraphics[scale=0.38]{lime2_hmm_dt_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{lime2_hmm_dt_det.pdf}
% \includegraphics[scale=0.38]{lime2_hmm_svm_acc.pdf} \hspace{1em}\vspace{1em}
% \includegraphics[scale=0.38]{lime2_hmm_svm_det.pdf}
% \includegraphics[scale=0.38]{lime2_hmm_nnet_acc.pdf} \hspace{1em}
% \includegraphics[scale=0.38]{lime2_hmm_nnet_det.pdf}
...
\begin{figure}[h]
 \centering
 %\includegraphics[scale=0.3]{vspace.png}
 \includegraphics[scale=0.38]{osu_dt_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_dt_cpd_hmm_compare_det_line.pdf} 
 \includegraphics[scale=0.38]{osu_svm_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{osu_svm_cpd_hmm_compare_det_line.pdf}
 \includegraphics[scale=0.38]{osu_nnet_cpd_hmm_compare_acc_line.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{osu_nnet_cpd_hmm_compare_det_line.pdf}
...
\begin{figure}[h]
 \centering
 %\includegraphics[scale=0.3]{vspace.png}
 \includegraphics[scale=0.38]{lime1_dt_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_dt_cpd_hmm_compare_det_line.pdf} 
 \includegraphics[scale=0.38]{lime1_svm_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime1_svm_cpd_hmm_compare_det_line.pdf}
 \includegraphics[scale=0.38]{lime1_nnet_cpd_hmm_compare_acc_line.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime1_nnet_cpd_hmm_compare_det_line.pdf}
...
\begin{figure}[h]
 \centering
 %\includegraphics[scale=0.3]{vspace.png}
 \includegraphics[scale=0.38]{lime2_dt_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_dt_cpd_hmm_compare_det_line.pdf} 
 \includegraphics[scale=0.38]{lime2_svm_cpd_hmm_compare_acc_line.pdf} \hspace{1em}\vspace{1em}
 \includegraphics[scale=0.38]{lime2_svm_cpd_hmm_compare_det_line.pdf}
 \includegraphics[scale=0.38]{lime2_nnet_cpd_hmm_compare_acc_line.pdf} \hspace{1em}
 \includegraphics[scale=0.38]{lime2_nnet_cpd_hmm_compare_det_line.pdf}
