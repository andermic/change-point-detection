...
\begin{figure}[H]
 \includegraphics[scale=0.35]{osu_cpd_dt_acc.pdf} \vspace{1em}
 \includegraphics[scale=0.35]{osu_cpd_dt_det.pdf}
 \includegraphics[scale=0.35]{osu_cpd_svm_acc.pdf} \vspace{1em}
 \includegraphics[scale=0.35]{osu_cpd_svm_det.pdf}
 \includegraphics[scale=0.35]{osu_cpd_nnet_acc.pdf} \hspace{2em}
